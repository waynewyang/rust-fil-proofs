...
pub const API_POREP_PROOF_BYTES: u32 = 384;
pub const API_POST_PROOF_BYTES: u32 = 192;
pub const CHALLENGE_COUNT: u32 = 2;
pub const DEGREE: u32 = 5;
pub const EXPANSION_DEGREE: u32 = 8;
pub const LAYERS: u32 = 4;
pub const NUM_SEAL_WORKERS: u32 = 2;
pub const POREP_PARTITIONS: u32 = 2;
pub const POST_CHALLENGE_COUNT: u32 = 30;
pub const POST_EPOCHS: u32 = 3;
pub const POST_PARTITIONS: u32 = 1;
pub const POST_SECTORS_COUNT: u32 = 2;
pub const POST_VDF_ROUNDS: u32 = 1;
pub const SLOTH_ITER: u32 = 0;
pub const SNARK_BYTES: u32 = 192;
pub const TAPER_LAYERS: u32 = 2;
...
pub const ConfiguredStore_Live: ConfiguredStore = 0;
pub const ConfiguredStore_Test: ConfiguredStore = 1;
pub type ConfiguredStore = u32;
pub const FCPResponseStatus_FCPNoError: FCPResponseStatus = 0;
pub const FCPResponseStatus_FCPUnclassifiedError: FCPResponseStatus = 1;
pub const FCPResponseStatus_FCPCallerError: FCPResponseStatus = 2;
pub const FCPResponseStatus_FCPReceiverError: FCPResponseStatus = 3;
pub type FCPResponseStatus = u32;
pub const FFISealStatus_Sealed: FFISealStatus = 0;
pub const FFISealStatus_Pending: FFISealStatus = 1;
pub const FFISealStatus_Failed: FFISealStatus = 2;
pub const FFISealStatus_Sealing: FFISealStatus = 3;
pub type FFISealStatus = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct SectorBuilder {
    _unused: [u8; 0],
}
#[doc = " AddPieceResponse"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[test]
fn bindgen_test_layout_AddPieceResponse() {
    assert_eq!(
        ::std::mem::size_of::<AddPieceResponse>(),
        24usize,
        concat!("Size of: ", stringify!(AddPieceResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<AddPieceResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(AddPieceResponse))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<AddPieceResponse>())).status_code as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(AddPieceResponse),
            "::",
            stringify!(status_code)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<AddPieceResponse>())).error_msg as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(AddPieceResponse),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<AddPieceResponse>())).sector_id as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(AddPieceResponse),
...
#[doc = " GeneratePoSTResult"]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct GeneratePoSTResponse {
    pub status_code: FCPResponseStatus,
    pub error_msg: *const ::std::os::raw::c_char,
    pub faults_len: usize,
    pub faults_ptr: *const u64,
    pub proof: [u8; 192usize],
}
#[test]
fn bindgen_test_layout_GeneratePoSTResponse() {
    assert_eq!(
        ::std::mem::size_of::<GeneratePoSTResponse>(),
        224usize,
        concat!("Size of: ", stringify!(GeneratePoSTResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<GeneratePoSTResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(GeneratePoSTResponse))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GeneratePoSTResponse>())).status_code as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(GeneratePoSTResponse),
            "::",
            stringify!(status_code)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GeneratePoSTResponse>())).error_msg as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(GeneratePoSTResponse),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GeneratePoSTResponse>())).faults_len as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(GeneratePoSTResponse),
            "::",
            stringify!(faults_len)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GeneratePoSTResponse>())).faults_ptr as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(GeneratePoSTResponse),
            "::",
            stringify!(faults_ptr)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GeneratePoSTResponse>())).proof as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(GeneratePoSTResponse),
...
#[doc = " GetMaxStagedBytesPerSector"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[test]
fn bindgen_test_layout_GetMaxStagedBytesPerSector() {
    assert_eq!(
        ::std::mem::size_of::<GetMaxStagedBytesPerSector>(),
        24usize,
        concat!("Size of: ", stringify!(GetMaxStagedBytesPerSector))
    );
    assert_eq!(
        ::std::mem::align_of::<GetMaxStagedBytesPerSector>(),
        8usize,
        concat!("Alignment of ", stringify!(GetMaxStagedBytesPerSector))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetMaxStagedBytesPerSector>())).status_code as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(GetMaxStagedBytesPerSector),
            "::",
            stringify!(status_code)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetMaxStagedBytesPerSector>())).error_msg as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetMaxStagedBytesPerSector>())).max_staged_bytes_per_sector
                as *const _ as usize
        },
        16usize,
        concat!(
            ...
            stringify!(GetMaxStagedBytesPerSector),
            "::",
            stringify!(max_staged_bytes_per_sector)
        )
    );
}
#[repr(C)]
...
pub struct FFIPieceMetadata {
    pub piece_key: *const ::std::os::raw::c_char,
    pub num_bytes: u64,
}
#[test]
fn bindgen_test_layout_FFIPieceMetadata() {
    assert_eq!(
        ::std::mem::size_of::<FFIPieceMetadata>(),
        16usize,
        concat!("Size of: ", stringify!(FFIPieceMetadata))
    );
    assert_eq!(
        ::std::mem::align_of::<FFIPieceMetadata>(),
        8usize,
        concat!("Alignment of ", stringify!(FFIPieceMetadata))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<FFIPieceMetadata>())).piece_key as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(FFIPieceMetadata),
            "::",
            stringify!(piece_key)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<FFIPieceMetadata>())).num_bytes as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(FFIPieceMetadata),
...
pub struct GetSealStatusResponse {
    ...
    pub seal_error_msg: *const ::std::os::raw::c_char,
    pub comm_d: [u8; 32usize],
    pub comm_r: [u8; 32usize],
    pub comm_r_star: [u8; 32usize],
    pub sector_access: *const ::std::os::raw::c_char,
    pub sector_id: u64,
    pub snark_proof: [u8; 384usize],
    pub pieces_len: usize,
    pub pieces_ptr: *const FFIPieceMetadata,
}
#[test]
fn bindgen_test_layout_GetSealStatusResponse() {
    assert_eq!(
        ::std::mem::size_of::<GetSealStatusResponse>(),
        544usize,
        concat!("Size of: ", stringify!(GetSealStatusResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<GetSealStatusResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(GetSealStatusResponse))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealStatusResponse>())).status_code as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
            "::",
            stringify!(status_code)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GetSealStatusResponse>())).error_msg as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealStatusResponse>())).seal_status_code as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
            "::",
            stringify!(seal_status_code)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealStatusResponse>())).seal_error_msg as *const _ as usize
        },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
            "::",
            stringify!(seal_error_msg)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GetSealStatusResponse>())).comm_d as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GetSealStatusResponse>())).comm_r as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealStatusResponse>())).comm_r_star as *const _ as usize
        },
        96usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
            "::",
            stringify!(comm_r_star)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealStatusResponse>())).sector_access as *const _ as usize
        },
        128usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
            "::",
            stringify!(sector_access)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<GetSealStatusResponse>())).sector_id as *const _ as usize },
        136usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealStatusResponse>())).snark_proof as *const _ as usize
        },
        144usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
            "::",
            stringify!(snark_proof)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealStatusResponse>())).pieces_len as *const _ as usize
        },
        528usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
            "::",
            stringify!(pieces_len)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealStatusResponse>())).pieces_ptr as *const _ as usize
        },
        536usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealStatusResponse),
            "::",
            stringify!(pieces_ptr)
        )
    );
}
#[doc = " FFISealedSectorMetadata"]
#[repr(C)]
#[derive(Copy, Clone)]
...
#[test]
fn bindgen_test_layout_FFISealedSectorMetadata() {
    assert_eq!(
        ::std::mem::size_of::<FFISealedSectorMetadata>(),
        512usize,
        concat!("Size of: ", stringify!(FFISealedSectorMetadata))
    );
    assert_eq!(
        ::std::mem::align_of::<FFISealedSectorMetadata>(),
        8usize,
        concat!("Alignment of ", stringify!(FFISealedSectorMetadata))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<FFISealedSectorMetadata>())).comm_d as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(FFISealedSectorMetadata),
            "::",
            stringify!(comm_d)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<FFISealedSectorMetadata>())).comm_r as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(FFISealedSectorMetadata),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFISealedSectorMetadata>())).comm_r_star as *const _ as usize
        },
        64usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFISealedSectorMetadata>())).sector_access as *const _ as usize
        },
        96usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFISealedSectorMetadata>())).sector_id as *const _ as usize
        },
        104usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFISealedSectorMetadata>())).snark_proof as *const _ as usize
        },
        112usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFISealedSectorMetadata>())).pieces_len as *const _ as usize
        },
        496usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFISealedSectorMetadata>())).pieces_ptr as *const _ as usize
        },
        504usize,
        concat!(
            "Offset of field: ",
...
#[doc = " GetSealedSectorsResponse"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct GetSealedSectorsResponse {
    pub status_code: FCPResponseStatus,
    pub error_msg: *const ::std::os::raw::c_char,
    pub sectors_len: usize,
    pub sectors_ptr: *const FFISealedSectorMetadata,
}
#[test]
fn bindgen_test_layout_GetSealedSectorsResponse() {
    assert_eq!(
        ::std::mem::size_of::<GetSealedSectorsResponse>(),
        32usize,
        concat!("Size of: ", stringify!(GetSealedSectorsResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<GetSealedSectorsResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(GetSealedSectorsResponse))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealedSectorsResponse>())).status_code as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealedSectorsResponse),
            "::",
            stringify!(status_code)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealedSectorsResponse>())).error_msg as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealedSectorsResponse>())).sectors_len as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealedSectorsResponse),
            "::",
            stringify!(sectors_len)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetSealedSectorsResponse>())).sectors_ptr as *const _ as usize
        },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(GetSealedSectorsResponse),
            "::",
            stringify!(sectors_ptr)
        )
    );
}
#[doc = " FFIStagedSectorMetadata"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[test]
fn bindgen_test_layout_FFIStagedSectorMetadata() {
    assert_eq!(
        ::std::mem::size_of::<FFIStagedSectorMetadata>(),
        48usize,
        concat!("Size of: ", stringify!(FFIStagedSectorMetadata))
    );
    assert_eq!(
        ::std::mem::align_of::<FFIStagedSectorMetadata>(),
        8usize,
        concat!("Alignment of ", stringify!(FFIStagedSectorMetadata))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFIStagedSectorMetadata>())).sector_access as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(FFIStagedSectorMetadata),
            "::",
            stringify!(sector_access)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFIStagedSectorMetadata>())).sector_id as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFIStagedSectorMetadata>())).pieces_len as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFIStagedSectorMetadata>())).pieces_ptr as *const _ as usize
        },
        24usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFIStagedSectorMetadata>())).seal_status_code as *const _
                as usize
        },
        32usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<FFIStagedSectorMetadata>())).seal_error_msg as *const _ as usize
        },
        40usize,
        concat!(
            "Offset of field: ",
...
#[test]
fn bindgen_test_layout_GetStagedSectorsResponse() {
    assert_eq!(
        ::std::mem::size_of::<GetStagedSectorsResponse>(),
        32usize,
        concat!("Size of: ", stringify!(GetStagedSectorsResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<GetStagedSectorsResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(GetStagedSectorsResponse))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetStagedSectorsResponse>())).status_code as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(GetStagedSectorsResponse),
            "::",
            stringify!(status_code)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetStagedSectorsResponse>())).error_msg as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetStagedSectorsResponse>())).sectors_len as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<GetStagedSectorsResponse>())).sectors_ptr as *const _ as usize
        },
        24usize,
        concat!(
            "Offset of field: ",
...
#[test]
fn bindgen_test_layout_InitSectorBuilderResponse() {
    assert_eq!(
        ::std::mem::size_of::<InitSectorBuilderResponse>(),
        24usize,
        concat!("Size of: ", stringify!(InitSectorBuilderResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<InitSectorBuilderResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(InitSectorBuilderResponse))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<InitSectorBuilderResponse>())).status_code as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(InitSectorBuilderResponse),
            "::",
            stringify!(status_code)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<InitSectorBuilderResponse>())).error_msg as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<InitSectorBuilderResponse>())).sector_builder as *const _
                as usize
        },
        16usize,
        concat!(
            ...
            stringify!(InitSectorBuilderResponse),
            "::",
            stringify!(sector_builder)
        )
    );
}
#[doc = " ReadPieceFromSealedSectorResponse"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[test]
fn bindgen_test_layout_ReadPieceFromSealedSectorResponse() {
    assert_eq!(
        ::std::mem::size_of::<ReadPieceFromSealedSectorResponse>(),
        32usize,
        concat!("Size of: ", stringify!(ReadPieceFromSealedSectorResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<ReadPieceFromSealedSectorResponse>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(ReadPieceFromSealedSectorResponse)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<ReadPieceFromSealedSectorResponse>())).status_code as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<ReadPieceFromSealedSectorResponse>())).error_msg as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<ReadPieceFromSealedSectorResponse>())).data_len as *const _
                as usize
        },
        16usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<ReadPieceFromSealedSectorResponse>())).data_ptr as *const _
                as usize
        },
        24usize,
        concat!(
...
#[doc = " SealAllStagedSectorsResponse"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[test]
fn bindgen_test_layout_SealAllStagedSectorsResponse() {
    assert_eq!(
        ::std::mem::size_of::<SealAllStagedSectorsResponse>(),
        16usize,
        concat!("Size of: ", stringify!(SealAllStagedSectorsResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<SealAllStagedSectorsResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(SealAllStagedSectorsResponse))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<SealAllStagedSectorsResponse>())).status_code as *const _
                as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(SealAllStagedSectorsResponse),
            "::",
            stringify!(status_code)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<SealAllStagedSectorsResponse>())).error_msg as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
#[test]
fn bindgen_test_layout_VerifyPoSTResponse() {
    assert_eq!(
        ::std::mem::size_of::<VerifyPoSTResponse>(),
        24usize,
        concat!("Size of: ", stringify!(VerifyPoSTResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<VerifyPoSTResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(VerifyPoSTResponse))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<VerifyPoSTResponse>())).status_code as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(VerifyPoSTResponse),
            "::",
            stringify!(status_code)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<VerifyPoSTResponse>())).error_msg as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(VerifyPoSTResponse),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<VerifyPoSTResponse>())).is_valid as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(VerifyPoSTResponse),
...
#[test]
fn bindgen_test_layout_VerifySealResponse() {
    assert_eq!(
        ::std::mem::size_of::<VerifySealResponse>(),
        24usize,
        concat!("Size of: ", stringify!(VerifySealResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<VerifySealResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(VerifySealResponse))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<VerifySealResponse>())).status_code as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(VerifySealResponse),
            "::",
            stringify!(status_code)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<VerifySealResponse>())).error_msg as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(VerifySealResponse),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<VerifySealResponse>())).is_valid as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(VerifySealResponse),
...
extern "C" {
    #[doc = " Writes user piece-bytes to a staged sector and returns the id of the sector"]
    #[doc = " to which the bytes were written."]
    #[link_name = "\u{1}_add_piece"]
    pub fn add_piece(
        ptr: *mut SectorBuilder,
        piece_key: *const ::std::os::raw::c_char,
        piece_ptr: *const u8,
        piece_len: usize,
    ) -> *mut AddPieceResponse;
}
extern "C" {
    #[link_name = "\u{1}_destroy_add_piece_response"]
    pub fn destroy_add_piece_response(ptr: *mut AddPieceResponse);
}
extern "C" {
    #[link_name = "\u{1}_destroy_generate_post_response"]
    pub fn destroy_generate_post_response(ptr: *mut GeneratePoSTResponse);
}
extern "C" {
    #[link_name = "\u{1}_destroy_get_max_user_bytes_per_staged_sector_response"]
    pub fn destroy_get_max_user_bytes_per_staged_sector_response(
        ptr: *mut GetMaxStagedBytesPerSector,
    );
}
extern "C" {
    #[link_name = "\u{1}_destroy_get_seal_status_response"]
    pub fn destroy_get_seal_status_response(ptr: *mut GetSealStatusResponse);
}
extern "C" {
    #[link_name = "\u{1}_destroy_get_sealed_sectors_response"]
    pub fn destroy_get_sealed_sectors_response(ptr: *mut GetSealedSectorsResponse);
}
extern "C" {
    #[link_name = "\u{1}_destroy_get_staged_sectors_response"]
    pub fn destroy_get_staged_sectors_response(ptr: *mut GetStagedSectorsResponse);
}
extern "C" {
    #[link_name = "\u{1}_destroy_init_sector_builder_response"]
    pub fn destroy_init_sector_builder_response(ptr: *mut InitSectorBuilderResponse);
}
extern "C" {
    #[link_name = "\u{1}_destroy_read_piece_from_sealed_sector_response"]
    pub fn destroy_read_piece_from_sealed_sector_response(
        ptr: *mut ReadPieceFromSealedSectorResponse,
    );
}
extern "C" {
    #[link_name = "\u{1}_destroy_seal_all_staged_sectors_response"]
    pub fn destroy_seal_all_staged_sectors_response(ptr: *mut SealAllStagedSectorsResponse);
}
extern "C" {
    #[doc = " Destroys a SectorBuilder."]
    #[link_name = "\u{1}_destroy_sector_builder"]
    pub fn destroy_sector_builder(ptr: *mut SectorBuilder);
}
extern "C" {
    #[link_name = "\u{1}_destroy_verify_post_response"]
    pub fn destroy_verify_post_response(ptr: *mut VerifyPoSTResponse);
}
extern "C" {
    #[link_name = "\u{1}_destroy_verify_seal_response"]
    pub fn destroy_verify_seal_response(ptr: *mut VerifySealResponse);
}
extern "C" {
    #[doc = " Generates a proof-of-spacetime for the given replica commitments."]
    #[link_name = "\u{1}_generate_post"]
    pub fn generate_post(
        ptr: *mut SectorBuilder,
        flattened_comm_rs_ptr: *const u8,
        flattened_comm_rs_len: usize,
        challenge_seed: *mut [u8; 32usize],
    ) -> *mut GeneratePoSTResponse;
}
extern "C" {
    #[doc = " Returns the number of user bytes that will fit into a staged sector."]
    #[link_name = "\u{1}_get_max_user_bytes_per_staged_sector"]
    pub fn get_max_user_bytes_per_staged_sector(
        ptr: *mut SectorBuilder,
    ) -> *mut GetMaxStagedBytesPerSector;
}
extern "C" {
    #[doc = " Returns sector sealing status for the provided sector id if it exists. If"]
    #[doc = " we don\'t know about the provided sector id, produce an error."]
    #[link_name = "\u{1}_get_seal_status"]
    pub fn get_seal_status(ptr: *mut SectorBuilder, sector_id: u64) -> *mut GetSealStatusResponse;
}
extern "C" {
    #[link_name = "\u{1}_get_sealed_sectors"]
    pub fn get_sealed_sectors(ptr: *mut SectorBuilder) -> *mut GetSealedSectorsResponse;
}
extern "C" {
    #[link_name = "\u{1}_get_staged_sectors"]
    pub fn get_staged_sectors(ptr: *mut SectorBuilder) -> *mut GetStagedSectorsResponse;
}
extern "C" {
    #[doc = " Initializes and returns a SectorBuilder."]
    #[link_name = "\u{1}_init_sector_builder"]
    pub fn init_sector_builder(
        sector_store_config_ptr: *const ConfiguredStore,
        last_used_sector_id: u64,
        metadata_dir: *const ::std::os::raw::c_char,
        prover_id: *mut [u8; 31usize],
        sealed_sector_dir: *const ::std::os::raw::c_char,
        staged_sector_dir: *const ::std::os::raw::c_char,
        max_num_staged_sectors: u8,
    ) -> *mut InitSectorBuilderResponse;
}
extern "C" {
    #[doc = " Unseals and returns the bytes associated with the provided piece key."]
    #[link_name = "\u{1}_read_piece_from_sealed_sector"]
    pub fn read_piece_from_sealed_sector(
        ptr: *mut SectorBuilder,
        piece_key: *const ::std::os::raw::c_char,
    ) -> *mut ReadPieceFromSealedSectorResponse;
}
extern "C" {
    #[doc = " For demo purposes. Seals all staged sectors."]
    #[link_name = "\u{1}_seal_all_staged_sectors"]
    pub fn seal_all_staged_sectors(ptr: *mut SectorBuilder) -> *mut SealAllStagedSectorsResponse;
}
extern "C" {
    #[doc = " Verifies that a proof-of-spacetime is valid."]
    #[link_name = "\u{1}_verify_post"]
    pub fn verify_post(
        _cfg_ptr: *const ConfiguredStore,
        _flattened_comm_rs_ptr: *const u8,
        _flattened_comm_rs_len: usize,
        _challenge_seed: *mut [u8; 32usize],
        proof: *mut [u8; 192usize],
        _faults_ptr: *const u64,
        _faults_len: usize,
    ) -> *mut VerifyPoSTResponse;
}
extern "C" {
    #[doc = " Verifies the output of seal."]
    #[doc = " # Arguments"]
    #[doc = "  `cfg_ptr`     - pointer to ConfiguredStore"]
    #[doc = "  `comm_r`      - replica commitment"]
    #[doc = "  `comm_d`      - data commitment"]
    #[doc = "  `comm_r_star` - layer-aggregated replica commitment"]
    #[doc = "  `prover_id`   - uniquely identifies the prover"]
    #[doc = "  `sector_id`   - uniquely identifies the sector"]
    #[doc = "  `proof`       - the proof, generated by seal()"]
    #[link_name = "\u{1}_verify_seal"]
    pub fn verify_seal(
        cfg_ptr: *const ConfiguredStore,
        comm_r: *mut [u8; 32usize],
        comm_d: *mut [u8; 32usize],
        comm_r_star: *mut [u8; 32usize],
        prover_id: *mut [u8; 31usize],
        sector_id: *mut [u8; 31usize],
        proof: *mut [u8; 384usize],
